    ...
    return(
        <>
            ...
            <div className="about-us-wrapper">
                ...
                <p className="about-us-paragraph">The Coyote Store is located directly across the street from the Borden County Museum, which is open on concert days. Visitors are encouraged to stop by and learn more about the rich history of the place where tradition lives and the legends play.</p>
